...
<div className='story-wrapper story-wrapper-doc'>
  ...
  <small>
    Icons from <a href='https://github.com/ionic-team/ionicons' target='_blank' rel='noreferrer'>Ionicons</a> - Premium hand-crafted icons built by Ionic.
  </small>
</div>
